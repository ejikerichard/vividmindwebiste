    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <h1 className="max-w-4xl bg-linear-to-br from-white to-gray-400 bg-clip-text text-center text-3xl font-medium leading-tight text-transparent sm:text-5xl sm:leading-tight md:text-7xl md:leading-tight">
          We believe in creating meaninful experiences that resonate with
          players.
        </h1>
        <p className="my-6 max-w-xl text-center text-base leading-relaxed md:text-lg md:leading-relaxed">
          Crafting immersive experiences that transcend reality. We engineer
          emotionally resonant game mechanics that bring virtual worlds to life.
        </p>
        <motion.button
          style={{
            border,
